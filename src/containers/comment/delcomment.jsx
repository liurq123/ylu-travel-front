...
import {reqAdd_DelComment} from '../../api/index'
...
class DelComment extends Component{
    ...
    submit = () => {
        reqAdd_DelComment({uid:this.props.user.id,fid:this.props.location.query.fid,content:this.state.content,score:this.state.score})
            .then(r => {
                console.log(r.data)
